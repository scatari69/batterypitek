  ...
  const DICT = {
    ...
    ru: {
      ...
      device: {
        ...
        etaNotDischarging: "Разряд не идёт",
        etaNotCharging: "Заряд не идёт",
        etaNoData: "Нет данных о ёмкости",
        eta: "До {pct} %: <b>≈ {dur}</b>",
        etaToFull: "До 100 %: <b>≈ {dur}</b>",
        etaFull: "Батарея заряжена",
        capRemain: "Остаток",
        capTotal: "Всего",
      ...
      admin: {
        ...
        targetSocHint: "До этого уровня считается оставшееся время при разряде — столбец ETA в списке батарей и строка на странице устройства (при заряде там время до 100 %). Он же — порог уведомления о низком заряде в Telegram.",
    ...
    uk: {
      ...
      device: {
        ...
        etaAtOrBelow: "Заряд уже ≤ {pct} %",
        etaNotDischarging: "Розряд не триває",
        etaNotCharging: "Заряд не триває",
        etaNoData: "Немає даних про ємність",
        eta: "До {pct} %: <b>≈ {dur}</b>",
        etaToFull: "До 100 %: <b>≈ {dur}</b>",
        etaFull: "Батарея заряджена",
        capRemain: "Залишок",
        capTotal: "Усього",
        capRes: "Опір",
      ...
      admin: {
        ...
        targetSocHint: "До цього рівня рахується час, що лишився під час розряду, — стовпець ETA у списку батарей і рядок на сторінці пристрою (під час заряду там час до 100 %). Він же — поріг сповіщення про низький заряд у Telegram.",
    ...
    en: {
      ...
      device: {
        ...
        etaNotDischarging: "Not discharging",
        etaNotCharging: "Not charging",
        etaNoData: "No capacity data",
        eta: "To {pct} %: <b>≈ {dur}</b>",
        etaToFull: "To 100 %: <b>≈ {dur}</b>",
        etaFull: "Battery charged",
        capRemain: "Remaining",
        capTotal: "Total",
        capRes: "Resistance",
      ...
      admin: {
        ...
        targetSocHint: "While discharging, remaining time is estimated down to this level — the ETA column in the battery list and the line on the device page (while charging they show time to 100 %). It is also the low-charge threshold for Telegram notifications.",
